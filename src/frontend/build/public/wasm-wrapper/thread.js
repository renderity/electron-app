						...
						(
							{
								...
								__muloti4: IDLE_FUNCTION,
								__trunctfdf2: IDLE_FUNCTION,
								console_log: (x) => console.log('%cWASM:', 'color: #bada55', x),
								console_log_c: (x) => console.log('%cWASM:', 'color: #bada55', String.fromCharCode(x)),
								console_log_s: (x) => console.log('%cWASM:', 'color: #bada55', this.CString2(x)),
								console_log_f: (x) => console.log('%cWASM:', 'color: #bada55', x),
								date_now: () => Date.now(),
							},
						),
